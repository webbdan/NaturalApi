...
/// <summary>
/// Tests proving Playwright executor handles all HTTP operations correctly.
/// </summary>
[TestClass]
public class PlaywrightBasicTests
{
    ...
    [TestMethod]
    public void PlaywrightExecutor_GetRequest_WorksCorrectly()
    {
        // Arrange
    ...
    [TestMethod]
    public void PlaywrightExecutor_PostRequest_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_PutRequest_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_PatchRequest_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_DeleteRequest_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_WithHeaders_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
        ...
        var result = api.For("/users")
            ...
            .WithHeader("User-Agent", "Playwright-Test")
            .Get();
    ...
    [TestMethod]
    public void PlaywrightExecutor_WithQueryParams_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_WithPathParams_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_WithCookies_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_WithTimeout_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_DeserializeResponse_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_ShouldReturnValidation_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
    ...
    [TestMethod]
    public void PlaywrightExecutor_ErrorHandling_WorksCorrectly()
    {
        // Arrange
        var services = PlaywrightTestHelpers.CreateServiceCollection(_wireMockServers!.BaseUrl);
        _serviceProvider = services.BuildServiceProvider();
